...
const Footer = () => {
                ...
                <Link to="/" >
                    <div className='flex gap-2 sm:flex-col items-center sm:items-start'>
                        <div className='flex flex-col md:flex-row md:items-center md:gap-4 '>
                            < Logo dimension={4} />
                            <p className='font-bold text-xl '>Shukhrana ❤️</p>
                        </div>
    ...
    <div className='absolute top-[20%] right-[15%] w-[12%] h-[12%] bg-white rounded-full'></div>
            ...
            <p className='font-bold flex justify-center bg-gradient-to-r from-gradient1a to-gradient1b border py-2 w-full'>Copyright &copy; | All rights reserved 2024</p>
        </>
    )
}
